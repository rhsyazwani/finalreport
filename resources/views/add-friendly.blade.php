...
<head>
    ...
    <title>Add Friendly Session</title>
...
<body>
    ...
    <div class="container form-container">
        <h1>Add Friendly Session</h1>
        <form method="POST" action="{{ route('friendly.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="court_no" name="court_no" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="team_one" name="team_one" required>
            </div>

            <div class="mb-3">
                <label for="team_two" class="form-label">Team Two</label>
                <input type="text" class="form-control" id="team_two" name="team_two" required>
            </div>
